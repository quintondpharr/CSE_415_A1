...
NOUN = ['husky', 'golden retriever', 'siamese', 'poodle', 
        'maine coon', 'beagle', 'persian', 'collar', 'leash', 'kibble', 'toy', 'litter box']

ANIMAL_SOUND = ['arf', 'meow', 'woof', 'chirp', 'moo', 'baa', 'cluck', 'hiss', 'neigh', 'oink']
